> **Canonical triage note** — Original path: `NALEX_EVIDENCE_BRIEF_headline_patterns.md` · Kept because: Best evidence brief for patterns and metrics: consistently separates Evidence from Interpretation line by line, states caveats and confidence levels on its face, and is designated by index.md Section 2 as the legitimate quick-framing reference alongside CURRENT_STATE_CLEAN.md. · Triage date: 2026-08-09
